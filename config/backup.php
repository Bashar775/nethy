...
return [
     ...
     */
            'keep_all_backups_for_days' => 5, // Keeps backups for the last 5 days

            // The following can remain at 0 if you only want the daily retention logic
